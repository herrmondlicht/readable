import { createPostFormBody } from ".";
import React from 'react';
import { assert } from 'chai'
import { shallow } from "../../../../testUtils";
import { stub, assert as sinonAssert } from "sinon";

describe('PostFormBody', () => {
  const PostFormBody = createPostFormBody(React),
    renderWithDefault = (props) => shallow(PostFormBody).withProps({
      updateFormData: stub(),
      formData: {},
      ...props
    })

  it('type fo PostFormBody', () => {
    assert.isFunction(PostFormBody, 'PostFormBody must be a function')
  });
